...
public class ImageBufferAnalyseGradient extends ImageBufferAnalyse
{
	private	double  			gr[][] ;
	...
	//=======================================================================================================================
	public 	void 	mapAreaGra(Graphics g,int a,int b,int A,int B) 
	{
		try {
