...
{	
	//=======================================================================================================================
	NarrowBand(Images im,double D, double R, double TNB,Stack pile,ObjCanva can,int echelle,int nbre_piles,int tailleNarrowBand)
	{
		IMG = 0.0 ;
		contexte 	= 0 ;
		front		= new Piles(nbre_piles) 	;
		front.Copie(0,pile) 	;	
		System.out.println("taille de la pile NB l'init = " + pile.size() ) ;
		p 			= new Points() ;
