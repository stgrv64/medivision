...
{	
	//=======================================================================================================================
	Brut(Images im,double D, double R,Stack pile,ObjCanva can,int echelle,int tailleNarrowBand)
	{
		contexte 	= 0 ;
		
		front		= new Piles(tailleNarrowBand+10) 	;
		front.Copie(0,pile) 	;	
		System.out.println("taille de la pile BRUT l'init = " + pile.size() ) ;
		p 			= new Points() ;
	...
	public void 	CarteDistanceBrute()
	{
		...
		for(i=0;i<1000000;i++) i=i ; // c'est une temporisation
