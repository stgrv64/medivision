...
public class Test extends Applet
{
    ...
    public void init() 
    {
		...
		lab = new Label(" - Conception et réalisation : Stéphane Gravois - stgrv@hotmail - 2003 - ",Label.CENTER) ;
		add("South",lab) ;
...
class ObjCanvas	extends JPanel implements MouseListener, MouseMotionListener, Runnable
{
	...
	{
		System.out.println("Chargement image echell " + echelle ) ; 
...
class ObjControls extends JPanel implements ActionListener,ItemListener, ChangeListener
{
    ...
    public ObjControls(ObjCanvas can) 
    {
		...
		// PB -------------------------------------------------------------------------------------------------------
		PB.setBackground(new Color(50,150,100)) ;
		PB.setLayout(GLB) ;	
		...
		// P2 -------------------------------------------------------------------------------------------------------
		P2.setBackground(new Color(50,150,100)) ;
		P2.setLayout(GL2) ;
		...
		// P3 -------------------------------------------------------------------------------------------------------
		P3.setBackground(new Color(50,150,100)) ;
		P3.setLayout(GL3) ;
    ...
    {	
		...
		if (   type.equals("Add") )	
		{	
			System.out.println("Requête ajout d'un front avec contexte = " + can.contexte) ;
